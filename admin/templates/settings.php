...
<div class="wrap">
    ...
    <form method="post" action="">
        ...
        <table class="form-table">
            <tr>
                <th scope="row"><label for="sr_referral_parameter"><?php esc_html_e( 'Nombre del Parámetro de Referido', 'smart-referrals' ); ?></label></th>
                <td>
                    <input name="sr_referral_parameter" type="text" id="sr_referral_parameter" value="<?php echo esc_attr( $parameter ); ?>" class="regular-text">
                    <p class="description"><?php esc_html_e( 'Ingresa el nombre del parámetro de referido (sin "?" ni "="). Por ejemplo: MYCODE', 'smart-referrals' ); ?></p>
                </td>
            </tr>
            <tr>
        ...
        <?php submit_button( 'Guardar cambios', 'primary', 'sr_save_settings' ); ?>
    </form>
</div>
