...
class SR_Referrals_List_Table extends WP_List_Table {
    ...
    public function column_status($item) {
        return $item['status'] === 'active' ? __('Active', 'smart-referrals') : __('Inactive', 'smart-referrals');
    }
    ...
    public function prepare_items() {
        ...
        foreach ($users as $user) {
            ...
            $active_status = get_user_meta($user->ID, 'active_status', true);
            ...
            $items[] = [
                ...
                'status'        => ($active_status === 'active' || empty($active_status)) ? 'active' : 'inactive',
            ];
        }
    ...
    public function process_bulk_action() {
        $user_ids = isset($_POST['referrals']) ? array_map('intval', $_POST['referrals']) : [];
