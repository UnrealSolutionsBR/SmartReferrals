...
class Smart_Referrals {
    ...
    public function enqueue_admin_styles() {
        wp_enqueue_style( 'sr-admin-styles', SR_PLUGIN_URL . 'assets/css/admin-styles.css', array(), '2.2.0' );

        // Enqueue admin scripts
        wp_enqueue_script( 'sr-admin-scripts', SR_PLUGIN_URL . 'assets/js/admin-scripts.js', array( 'jquery' ), '2.2.0', true );
    ...
    public function enqueue_frontend_styles() {
        wp_enqueue_style( 'sr-frontend-styles', SR_PLUGIN_URL . 'assets/css/frontend-styles.css', array(), '2.2.0' );

        // Enqueue custom styles for the referral copy link
        wp_enqueue_style( 'sr-referral-copylink-styles', SR_PLUGIN_URL . 'assets/css/referral-copylink.css', array(), '2.2.0' );
    }

    public function enqueue_frontend_scripts() {
        wp_enqueue_script( 'sr-referral-copylink-script', SR_PLUGIN_URL . 'assets/js/referral-copylink.js', array( 'jquery' ), '2.2.0', true );
